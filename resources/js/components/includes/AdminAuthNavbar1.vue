    ...
    <span>
        <v-app-bar flat light color="transparent white--text" class="mb-n5">
            <span class="hidden-md-and-up">
                <v-app-bar-nav-icon class="primary--text hidden-md-and-up" @click="adminNavdrawer = true"></v-app-bar-nav-icon>
            </span>
            ...
            <v-spacer></v-spacer>
            <!-- <span class="primary--text mt-1 mr-5"> {{ authAdmin.fullname }}</span> -->
        ...
        <v-navigation-drawer absolute v-model="adminNavdrawer" color="primary white--text" class="hidden-md-and-up" disable-resize-watcher>
