            ...
            <v-col cols="12" md="8">
                <v-card light raised elevation="12" min-height="300" class="mx-auto">
                    ...
                    <v-card-text class="body-1 mt-5 px-8 pb-5">
                        ...
                        <v-textarea label="Description Of Service" placeholder="Give details of the service you offer" rows="3" auto-grow v-model="service.description" required v-validate="'required|min:10|max:600'" :error-messages="errors.collect('description')" name="description"></v-textarea>
